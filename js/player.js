...
export class Player {
  constructor(x,facingRight,color,faceImgSrc){
    ...
    this.specialCharge=0;this.specialActive=false;this.specialTimer=0;this.specialName='';this.lastSpecialName='';
  ...
  reset(){
    ...
    this.specialActive=false;this.specialTimer=0;this.specialActivatedAt=0;this.specialName='';this.lastSpecialName='';
    this.consecutiveKicks=0;
  ...
  activateSpecial(name,globalFrame){
    ...
    this.specialName=name;this.lastSpecialName=name;this.specialCharge=0;this.stats.usedSpecial=true;
