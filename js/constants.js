...
export const AI_LEVELS = [
  ...
  { reactionTime:8,aggression:0.35,blockChance:0.25,attackMix:0.45,punishAbility:0.30,moveSpeed:2.2,jumpChance:0.02,specialUseChance:0,spacingSkill:0.28,retreatSkill:0.03,comboSkill:0.22,approachBias:0.45,aiSpecialMaxPerRound:0 },
  { reactionTime:6,aggression:0.40,blockChance:0.35,attackMix:0.35,punishAbility:0.50,moveSpeed:2.75,jumpChance:0.04,specialUseChance:0.40,spacingSkill:0.50,retreatSkill:0.05,comboSkill:0.49,approachBias:0.50,aiSpecialMaxPerRound:1 },
  { reactionTime:4,aggression:0.50,blockChance:0.45,attackMix:0.34,punishAbility:0.50,moveSpeed:3.5,jumpChance:0.05,specialUseChance:0.60,spacingSkill:0.50,retreatSkill:0.05,comboSkill:0.49,approachBias:0.60,aiSpecialMaxPerRound:2 },
  { reactionTime:3,aggression:0.65,blockChance:0.50,attackMix:0.19,punishAbility:0.74,moveSpeed:4.0,jumpChance:0.08,specialUseChance:0.80,spacingSkill:0.74,retreatSkill:0.08,comboSkill:0.74,approachBias:0.65,isBoss:true,aiSpecialMaxPerRound:3 },
];
export const NO_DAMAGE_ENGAGE_TIME = 900;
// Hold attack debounce — REMOVED (now uses instant-tap + hold-to-charge)
export const HOLD_DEBOUNCE = 8; // legacy, unused
